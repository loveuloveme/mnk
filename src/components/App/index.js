                            ...
                            <div className="inner-section">
                                ...
                                <div className="result">
                                    <div className="result-item">
                                        <span className="result-item__value">b<span className="result-item__index"></span></span>=<span className="result-item__result">{result.b.toFixed(4)}</span>
                                    </div>
                                    <div className="result-item">
                                        <span className="result-item__value">a<span className="result-item__index"></span></span>=<span className="result-item__result">{result.a.toFixed(4)}</span>
                                    </div>
                                    <div className="result-item">
